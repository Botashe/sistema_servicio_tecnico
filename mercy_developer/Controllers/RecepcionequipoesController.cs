...
namespace mercy_developer.Controllers
{
    public class RecepcionequipoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,TipoPc,Accesorio,MarcaPc,ModeloPc,NseriePc,CapacidadRam,TipoAlmacenamiento,CapacidadAlmacenamiento,TipoGpu,Grafico,ClienteId,ServicioId")] Recepcionequipo recepcionequipo)
        {
            if (recepcionequipo.Accesorio !=null)
            {
                _context.Recepcionequipos.Add(recepcionequipo);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,TipoPc,Accesorio,MarcaPc,ModeloPc,NseriePc,CapacidadRam,TipoAlmacenamiento,CapacidadAlmacenamiento,TipoGpu,Grafico,ClienteId,ServicioId")] Recepcionequipo recepcionequipo)
        {
